...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="GET" class="show">
            <table>
                <tr>
                    <td>Employee ID</td>
                    <td><input type="number" name="eid" min="1"></td>
                    <td class="btn"><input type="submit" value="Show Data" name="showdata"></td>
                </tr>
            </table>
        </form>
        <?php
            if(isset($_GET['showdata'])){
                ...
                $eid=$_GET['eid'];
                $sql="SELECT * from tbl_employee where e_id='{$eid}'";
        ...
        <form action="" method="POST">
            ...
            <tr>
                    <td>Name</td>
                    <td>
                        <input type="number" name="id" min="1" value="<?php echo $row['e_id']; ?>" hidden>
                        <input type="text" name="name" value="<?php echo $row['e_name']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Email</td>
...
<?php
    ...
    if($_POST){
        ...
        $usql="UPDATE tbl_employee SET e_name='{$name}',e_email='{$email}',e_number='{$mobile}',e_gender='{$gender}',e_city='{$city}',e_department='{$department}',e_salary='{$salary}' WHERE e_id={$id}";      
